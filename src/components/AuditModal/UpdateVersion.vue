 ...
 * @LastEditTime: 2023-01-13 11:26:04
 * @LastEditors: 赵婷婷
...
export default {
  ...
  computed: {
    env() {
      if (
        window.location.origin.includes('https://shandianyun-sck.iqilu.com')
      ) {
        return 'prod'
      } else if (
        window.location.origin.includes('https://sucai.shandian8.com')
      ) {
        return 'test'
      }
