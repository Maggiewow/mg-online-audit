 ...
 * @LastEditors: 赵婷婷
 * @LastEditTime: 2023-08-10 14:10:51
 */
...
const getArticleUrl = () => {
	...
	if (objStr) {
		...
		return urlObj.articleUrl || ''
	}

	return 'https://shandianyun-article.iqilu.com'
}
const getSeriesUrl = () => {
	let objStr = sessionStorage.getItem('baseUrlObj')
	if (objStr) {
		let urlObj = JSON.parse(objStr)
		return urlObj.seriesUrl || ''
	}

	return 'https://shandianyun-series.iqilu.com'
}
